...
@Component({
  selector: 'app-consultant-shop-clean-checkout',
  templateUrl: './clean-checkout.component.html',
  styleUrls: ['./clean-checkout.component.less']
})
export class CleanCheckoutComponent implements OnInit, AfterViewChecked {
