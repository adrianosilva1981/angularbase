...
@Component({
  selector: 'app-consultant-shop-filter-product',
  templateUrl: './filter-product.component.html',
  styleUrls: ['./filter-product.component.less']
})
export class FilterProdctComponent implements OnInit {
  ...
  attBreadCrumb(department = null) {
    ...
    if (!department) {
      ...
      aux = [
        { 'text': 'Departamentos', 'router': this._sharedService.getSubdomainOwnerStore() + '/department/product' },
