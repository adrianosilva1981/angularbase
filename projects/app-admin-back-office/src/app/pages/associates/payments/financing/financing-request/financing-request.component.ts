...
@Component({
  selector: 'app-admin-back-office-financing-request',
  templateUrl: './financing-request.component.html',
  styleUrls: ['./financing-request.component.less']
})
export class FinancingRequestComponent implements OnInit {
  ...
  public associates: any[] = [];
    ...
    financingRequest(username: string) {
        this._router.navigate(['/associates/payments/financing-request/solicitation-financing/' + username]);
    }
}
