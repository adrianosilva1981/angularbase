...
@Component({
  selector: 'app-admin-back-office-financial-closing',
  templateUrl: './financial-closing.component.html',
  styleUrls: ['./financial-closing.component.less']
})
export class FinancialClosingComponent implements OnInit {
