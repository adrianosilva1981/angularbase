...
@Component({
    selector: 'app-admin-back-office-info-rescue',
...
export class InfoRescueComponent implements OnInit {
    ...
    public cols: any[] = [
        ...
        { field: 'payment_date', header: 'Data de Pagamento' }
    ];
    ...
    getSummaryRescue() {
        ...
        this._sharedService.getSummaryRescue(data).subscribe(
            response => {
                if (response.return) {
