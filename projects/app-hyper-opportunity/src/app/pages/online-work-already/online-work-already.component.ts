...
@Component({
  selector: 'app-hyper-opportunity-online-work-already',
  templateUrl: './online-work-already.component.html',
  styleUrls: ['./online-work-already.component.less']
})
export class OnlineWorkAlreadyComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    const bread = [
      ...
      { 'text': 'Para você que já trabalha como freelancer', 'router': '' }
    ];
